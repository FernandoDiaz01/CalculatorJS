window.addEventListener('load', () => { /*Escuchamos cuando se carga el documento */
    ...
    /* Creamos dos constantes y nos gurdamos los elementos que necesitamos*/
...
function calcular(display) {
    display.innerHTML = eval(display.innerHTML) /* Toma el string, resolverlo y guardarlo en el innerHTML del display*/
}
